...
sp <- data_model |> 
  filter(species.cor == "Quercus faginea")
...
## Data summary for Quercus faginea
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus faginea"), "predictions.rds", sep = "_")))
