...
sp <- data_model |> 
  filter(species.cor == "Populus tremula")
...
## Data summary for Populus tremula
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Populus tremula"), "predictions.rds", sep = "_")))
