...
sp <- data_model |> 
  filter(species.cor == "Quercus nigra")
...
## Data summary for Quercus nigra
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus nigra"), "predictions.rds", sep = "_")))
