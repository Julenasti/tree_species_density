...
sp <- data_model |> 
  filter(species.cor == "Pinus palustris")
...
## Data summary for Pinus palustris
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus palustris"), "predictions.rds", sep = "_")))
