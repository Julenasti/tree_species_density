...
sp <- data_model |> 
  filter(species.cor == "Prunus serotina")
...
## Data summary for Prunus serotina
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Prunus serotina"), "predictions.rds", sep = "_")))
