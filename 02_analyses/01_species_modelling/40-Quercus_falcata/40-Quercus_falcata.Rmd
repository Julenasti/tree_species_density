...
sp <- data_model |> 
  filter(species.cor == "Quercus falcata")
...
## Data summary for Quercus falcata
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus falcata"), "predictions.rds", sep = "_")))
