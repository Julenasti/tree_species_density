...
sp <- data_model |> 
  filter(species.cor == "Quercus velutina")
...
## Data summary for Quercus velutina
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus velutina"), "predictions.rds", sep = "_")))
