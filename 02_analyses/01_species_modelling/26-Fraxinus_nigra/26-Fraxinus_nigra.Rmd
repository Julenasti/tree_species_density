...
sp <- data_model |> 
  filter(species.cor == "Fraxinus nigra")
...
## Data summary for Fraxinus nigra
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Fraxinus nigra"), "predictions.rds", sep = "_")))
