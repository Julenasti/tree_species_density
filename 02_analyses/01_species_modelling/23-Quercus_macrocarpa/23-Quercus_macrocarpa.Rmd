...
sp <- data_model |> 
  filter(species.cor == "Quercus macrocarpa")
...
## Data summary for Quercus macrocarpa
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus macrocarpa"), "predictions.rds", sep = "_")))
