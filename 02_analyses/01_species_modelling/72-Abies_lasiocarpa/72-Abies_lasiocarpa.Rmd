...
sp <- data_model |> 
  filter(species.cor == "Abies lasiocarpa")
...
## Data summary for Abies lasiocarpa
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Abies lasiocarpa"), "predictions.rds", sep = "_")))
