...
sp <- data_model |> 
  filter(species.cor == "Fraxinus pennsylvanica")
...
## Data summary for Fraxinus pennsylvanica
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Fraxinus pennsylvanica"), "predictions.rds", sep = "_")))
