...
sp <- data_model |> 
  filter(species.cor == "Pinus ponderosa")
...
## Data summary for Pinus ponderosa
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus ponderosa"), "predictions.rds", sep = "_")))
