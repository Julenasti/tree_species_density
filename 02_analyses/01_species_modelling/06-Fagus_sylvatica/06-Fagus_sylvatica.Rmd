...
## Data summary for Fagus sylvatica
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Fagus sylvatica"), "predictions.rds", sep = "_")))
