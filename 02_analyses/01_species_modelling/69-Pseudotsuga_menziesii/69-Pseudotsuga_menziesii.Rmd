...
sp <- data_model |> 
  filter(species.cor == "Pseudotsuga menziesii")
...
## Data summary for Pseudotsuga menziesii
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pseudotsuga menziesii"), "predictions.rds", sep = "_")))
