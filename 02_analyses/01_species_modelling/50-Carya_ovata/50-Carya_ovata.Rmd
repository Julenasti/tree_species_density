...
sp <- data_model |> 
  filter(species.cor == "Carya ovata")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Carya ovata"), "predictions.rds", sep = "_")))
