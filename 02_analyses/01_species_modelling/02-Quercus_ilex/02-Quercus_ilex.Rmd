...
sp <- data_model |> 
  filter(species.cor == "Quercus ilex")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus ilex"), "predictions.rds", sep = "_")))
