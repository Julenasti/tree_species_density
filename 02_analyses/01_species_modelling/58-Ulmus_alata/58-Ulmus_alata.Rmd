...
sp <- data_model |> 
  filter(species.cor == "Ulmus alata")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Ulmus alata"), "predictions.rds", sep = "_")))
