...
sp <- data_model |> 
  filter(species.cor == "Pinus contorta")
...
## Data summary for Pinus contorta
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus contorta"), "predictions.rds", sep = "_")))
