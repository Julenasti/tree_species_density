...
sp <- data_model |> 
  filter(species.cor == "Quercus coccinea")
...
## Data summary for Quercus coccinea
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus coccinea"), "predictions.rds", sep = "_")))
