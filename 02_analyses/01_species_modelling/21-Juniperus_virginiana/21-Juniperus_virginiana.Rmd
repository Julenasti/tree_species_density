...
sp <- data_model |> 
  filter(species.cor == "Juniperus virginiana")
...
## Data summary for Juniperus virginiana
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Juniperus virginiana"), "predictions.rds", sep = "_")))
