...
sp <- data_model |> 
  filter(species.cor == "Fagus grandifolia")
...
## Data summary for Fagus grandifolia
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Fagus grandifolia"), "predictions.rds", sep = "_")))
