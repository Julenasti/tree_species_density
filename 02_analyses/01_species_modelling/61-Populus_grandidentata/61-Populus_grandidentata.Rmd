...
sp <- data_model |> 
  filter(species.cor == "Populus grandidentata")
...
## Data summary for Populus grandidentata
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Populus grandidentata"), "predictions.rds", sep = "_")))
