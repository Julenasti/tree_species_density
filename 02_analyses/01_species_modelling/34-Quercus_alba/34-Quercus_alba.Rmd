...
sp <- data_model |> 
  filter(species.cor == "Quercus alba")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus alba"), "predictions.rds", sep = "_")))
