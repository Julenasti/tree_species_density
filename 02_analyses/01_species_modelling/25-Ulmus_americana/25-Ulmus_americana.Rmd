...
sp <- data_model |> 
  filter(species.cor == "Ulmus americana")
...
## Data summary for Ulmus americana
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Ulmus americana"), "predictions.rds", sep = "_")))
