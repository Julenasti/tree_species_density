...
sp <- data_model |> 
  filter(species.cor == "Quercus laurifolia")
...
## Data summary for Quercus laurifolia
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus laurifolia"), "predictions.rds", sep = "_")))
