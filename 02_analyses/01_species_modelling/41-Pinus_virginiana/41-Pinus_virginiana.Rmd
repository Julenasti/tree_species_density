...
sp <- data_model |> 
  filter(species.cor == "Pinus virginiana")
...
## Data summary for Pinus virginiana
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus virginiana"), "predictions.rds", sep = "_")))
