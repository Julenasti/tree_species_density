...
sp <- data_model |> 
  filter(species.cor == "Betula papyrifera")
...
## Data summary for Betula papyrifera
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Betula papyrifera"), "predictions.rds", sep = "_")))
