...
sp <- data_model |> 
  filter(species.cor == "Liquidambar styraciflua")
...
## Data summary for Liquidambar styraciflua
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Liquidambar styraciflua"), "predictions.rds", sep = "_")))
