...
sp <- data_model |> 
  filter(species.cor == "Fraxinus americana")
...
## Data summary for Fraxinus americana
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Fraxinus americana"), "predictions.rds", sep = "_")))
