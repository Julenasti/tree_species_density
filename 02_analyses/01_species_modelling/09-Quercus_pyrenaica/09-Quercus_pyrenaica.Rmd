...
sp <- data_model |> 
  filter(species.cor == "Quercus pyrenaica")
...
## Data summary for Quercus pyrenaica
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus pyrenaica"), "predictions.rds", sep = "_")))
