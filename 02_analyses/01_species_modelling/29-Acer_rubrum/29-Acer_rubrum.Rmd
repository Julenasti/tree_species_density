...
sp <- data_model |> 
  filter(species.cor == "Acer rubrum")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Acer rubrum"), "predictions.rds", sep = "_")))
