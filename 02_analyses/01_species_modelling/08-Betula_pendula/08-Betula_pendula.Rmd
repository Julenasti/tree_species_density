...
sp <- data_model |> 
  filter(species.cor == "Betula pendula")
...
## Data summary for Betula pendula
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Betula pendula"), "predictions.rds", sep = "_")))
