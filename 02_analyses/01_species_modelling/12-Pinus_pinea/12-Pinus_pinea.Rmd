...
sp <- data_model |> 
  filter(species.cor == "Pinus pinea")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus pinea"), "predictions.rds", sep = "_")))
