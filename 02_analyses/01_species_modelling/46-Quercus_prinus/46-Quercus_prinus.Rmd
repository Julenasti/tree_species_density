...
sp <- data_model |> 
  filter(species.cor == "Quercus prinus")
...
## Data summary for Quercus prinus
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus prinus"), "predictions.rds", sep = "_")))
