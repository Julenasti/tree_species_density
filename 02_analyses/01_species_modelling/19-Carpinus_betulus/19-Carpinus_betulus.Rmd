...
sp <- data_model |> 
  filter(species.cor == "Carpinus betulus")
...
## Data summary for Carpinus betulus
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Carpinus betulus"), "predictions.rds", sep = "_")))
