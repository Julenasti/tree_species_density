...
sp <- data_model |> 
  filter(species.cor == "Thuja occidentalis")
...
## Data summary for Thuja occidentalis
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Thuja occidentalis"), "predictions.rds", sep = "_")))
