...
sp <- data_model |> 
  filter(species.cor == "Fraxinus excelsior")
...
## Data summary for Fraxinus excelsior
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Fraxinus excelsior"), "predictions.rds", sep = "_")))
