...
sp <- data_model |> 
  filter(species.cor == "Abies balsamea")
...
## Data summary for Abies balsamea
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Abies balsamea"), "predictions.rds", sep = "_")))
