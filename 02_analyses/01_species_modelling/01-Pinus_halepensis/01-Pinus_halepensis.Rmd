...
sp <- data_model |> 
  filter(species.cor == "Pinus halepensis")
...
## Data summary for Pinus halepensis
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus halepensis"), "predictions.rds", sep = "_")))
