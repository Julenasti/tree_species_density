...
sp <- data_model |> 
  filter(species.cor == "Picea abies")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Picea abies"), "predictions.rds", sep = "_")))
