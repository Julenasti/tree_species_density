...
sp <- data_model |> 
  filter(species.cor == "Nyssa sylvatica")
...
## Data summary for Nyssa sylvatica
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Nyssa sylvatica"), "predictions.rds", sep = "_")))
