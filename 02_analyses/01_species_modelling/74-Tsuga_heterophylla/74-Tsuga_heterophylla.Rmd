...
## Data summary for Tsuga heterophylla
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Tsuga heterophylla"), "predictions.rds", sep = "_")))
