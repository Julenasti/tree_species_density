...
sp <- data_model |> 
  filter(species.cor == "Betula alleghaniensis")
...
## Data summary for Betula alleghaniensis
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Betula alleghaniensis"), "predictions.rds", sep = "_")))
