...
sp <- data_model |> 
  filter(species.cor == "Quercus robur")
...
## Data summary for Quercus robur
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus robur"), "predictions.rds", sep = "_")))
