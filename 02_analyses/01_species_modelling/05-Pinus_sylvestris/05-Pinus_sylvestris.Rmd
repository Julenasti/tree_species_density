...
sp <- data_model |> 
  filter(species.cor == "Pinus sylvestris")
...
## Data summary for Pinus sylvestris
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus sylvestris"), "predictions.rds", sep = "_")))
