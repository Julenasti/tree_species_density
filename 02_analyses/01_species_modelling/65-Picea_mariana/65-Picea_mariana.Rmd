...
sp <- data_model |> 
  filter(species.cor == "Picea mariana")
...
## Data summary for Picea mariana
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Picea mariana"), "predictions.rds", sep = "_")))
