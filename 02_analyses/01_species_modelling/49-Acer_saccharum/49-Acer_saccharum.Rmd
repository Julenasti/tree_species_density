...
sp <- data_model |> 
  filter(species.cor == "Acer saccharum")
...
## Data summary for Acer saccharum
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Acer saccharum"), "predictions.rds", sep = "_")))
