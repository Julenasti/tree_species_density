...
sp <- data_model |> 
  filter(species.cor == "Liriodendron tulipifera")
...
## Data summary for Liriodendron tulipifera
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Liriodendron tulipifera"), "predictions.rds", sep = "_")))
