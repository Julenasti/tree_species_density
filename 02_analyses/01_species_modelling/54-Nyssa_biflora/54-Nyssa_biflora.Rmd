...
sp <- data_model |> 
  filter(species.cor == "Nyssa biflora")
...
## Data summary for Nyssa biflora
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Nyssa biflora"), "predictions.rds", sep = "_")))
