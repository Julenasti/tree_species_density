...
sp <- data_model |> 
  filter(species.cor == "Betula pubescens")
...
## Data summary for Betula pubescens
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Betula pubescens"), "predictions.rds", sep = "_")))
