...
sp <- data_model |> 
  filter(species.cor == "Pinus pinaster")
...
## Data summary for Pinus pinaster
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus pinaster"), "predictions.rds", sep = "_")))
