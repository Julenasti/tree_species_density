...
sp <- data_model |> 
  filter(species.cor == "Betula lenta")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Betula lenta"), "predictions.rds", sep = "_")))
