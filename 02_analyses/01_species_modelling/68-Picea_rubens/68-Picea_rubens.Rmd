...
sp <- data_model |> 
  filter(species.cor == "Picea rubens")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Picea rubens"), "predictions.rds", sep = "_")))
