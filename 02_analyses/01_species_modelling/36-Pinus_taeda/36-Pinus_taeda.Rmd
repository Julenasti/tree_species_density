...
sp <- data_model |> 
  filter(species.cor == "Pinus taeda")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus taeda"), "predictions.rds", sep = "_")))
