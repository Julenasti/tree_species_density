...
sp <- data_model |> 
  filter(species.cor == "Pinus nigra")
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus nigra"), "predictions.rds", sep = "_")))
