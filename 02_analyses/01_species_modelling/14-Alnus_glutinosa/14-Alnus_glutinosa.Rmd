...
sp <- data_model |> 
  filter(species.cor == "Alnus glutinosa")
...
## Data summary for Alnus glutinosa
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Alnus glutinosa"), "predictions.rds", sep = "_")))
