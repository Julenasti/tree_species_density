...
sp <- data_model |> 
  filter(species.cor == "Quercus stellata")
...
## Data summary for Quercus stellata
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Quercus stellata"), "predictions.rds", sep = "_")))
