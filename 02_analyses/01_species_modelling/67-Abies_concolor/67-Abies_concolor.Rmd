...
sp <- data_model |> 
  filter(species.cor == "Abies concolor")
...
## Data summary for Abies concolor
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Abies concolor"), "predictions.rds", sep = "_")))
