...
sp <- data_model |> 
  filter(species.cor == "Abies grandis")
...
## Data summary for Abies grandis
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Abies grandis"), "predictions.rds", sep = "_")))
