...
sp <- data_model |> 
  filter(species.cor == "Oxydendrum arboreum")
...
## Data summary for Oxydendrum arboreum
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Oxydendrum arboreum"), "predictions.rds", sep = "_")))
