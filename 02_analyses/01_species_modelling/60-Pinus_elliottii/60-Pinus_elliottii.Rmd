...
sp <- data_model |> 
  filter(species.cor == "Pinus elliottii")
...
## Data summary for Pinus elliottii
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus elliottii"), "predictions.rds", sep = "_")))
