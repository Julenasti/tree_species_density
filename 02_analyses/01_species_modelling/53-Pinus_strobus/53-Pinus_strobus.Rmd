...
sp <- data_model |> 
  filter(species.cor == "Pinus strobus")
...
## Data summary for Pinus strobus
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Pinus strobus"), "predictions.rds", sep = "_")))
