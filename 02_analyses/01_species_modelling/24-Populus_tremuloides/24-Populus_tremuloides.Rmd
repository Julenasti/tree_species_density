...
sp <- data_model |> 
  filter(species.cor == "Populus tremuloides")
...
## Data summary for Populus tremuloides
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Populus tremuloides"), "predictions.rds", sep = "_")))
