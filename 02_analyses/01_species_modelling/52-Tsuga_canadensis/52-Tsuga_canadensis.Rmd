...
sp <- data_model |> 
  filter(species.cor == "Tsuga canadensis")
...
## Data summary for Tsuga canadensis
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Tsuga canadensis"), "predictions.rds", sep = "_")))
