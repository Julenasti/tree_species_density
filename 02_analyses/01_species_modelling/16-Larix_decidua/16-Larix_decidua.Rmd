...
sp <- data_model |> 
  filter(species.cor == "Larix decidua")
...
## Data summary for Larix decidua
...
saveRDS(predictions_all_changes, file = here("01_data", "species_predictions", paste(sub(" ", "_", "Larix decidua"), "predictions.rds", sep = "_")))
