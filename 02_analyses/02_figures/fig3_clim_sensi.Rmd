...
predictions_group_std <- predictions_group |>
  mutate(
    mean.wood.density.sp.log = log(mean.wood.density.sp),
    aridity.mean.sp.log = log(aridity.mean.sp),
    mean.seed.dry.mass.sp.log = log(mean.seed.dry.mass.sp),
    across(c(bio11.mean.sp,
             aridity.mean.sp,
             aridity.mean.sp.log,
             mean.wood.density.sp,
             mean.wood.density.sp.log,
             mean.seed.dry.mass.sp,
             mean.seed.dry.mass.sp.log),
...
summary(predictions_group_std$mean.seed.dry.mass.sp)
summary(predictions_group_std$mean.seed.dry.mass.sp.std)
