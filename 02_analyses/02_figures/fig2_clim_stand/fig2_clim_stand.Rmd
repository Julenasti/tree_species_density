---
title: "Quantify species abundance shifts adjusting for stand development"
...
data_eu <- readRDS(file = here("02-data", "processed", "eu_sp_data.rds"))

unique(data_eu$species.cor)
...
predictions_all_changes <- left_join(predictions_all_changes, data_model_s, by = c("tmt.plot.id", "species.cor"))
...
ggsave(
  ...
  here("04-results", "figures", "fig2", "fig2_intrasp_eu.png"),
  width = 8, height = 8,
  dpi = 600
)
...
walk2(gg_pred_us_all, v_pred_us_all, \(x, y) ggsave(
  plot = x,
  filename = here("04-results", "figures", "fig2", y),
  width = 8, height = 8,
  dpi = 600
  ))
...
ggsave(
  plot = fig2_hist,
  here("04-results", "figures", "fig2", "fig2_hist.png"),
  width = 8, height = 2.1,
  dpi = 600
)
...
ggsave(
  plot = fig2_slab,
  here("04-results", "figures", "fig2", "fig2_slab.png"),
  width = 10, height = 8.2,
  dpi = 600
)

fig2_hist_m <- image_read(here("04-results", "figures", "fig2", "fig2_hist.png"))

fig2_slab_m <- image_read(here("04-results", "figures", "fig2", "fig2_slab.png"))
...
image_write(fig2_main_m, here(
  "04-results", "figures", "fig2", "fig2_main.png"
), density = 600)
...
# overlapping 0
observed_overlap <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) overlap(
  x = x, 
  var1 = "predFE_observed_climsen_q_0025",
  var2 = "predFE_observed_climsen_q_0975"))

low_overlap <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) overlap(
  x = x, 
  var1 = "predFE_low_climsen_q_0025",
  var2 = "predFE_low_climsen_q_0975"))

high_overlap <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) overlap(
  x = x, 
  var1 = "predFE_high_climsen_q_0025",
  var2 = "predFE_high_climsen_q_0975"))

# all negative
observed_negative <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) all_negative(
  x = x, 
  var1 = "predFE_observed_climsen_q_0025",
  var2 = "predFE_observed_climsen_q_0975"))

low_negative <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) all_negative(
  x = x, 
  var1 = "predFE_low_climsen_q_0025",
  var2 = "predFE_low_climsen_q_0975"))

high_negative <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) all_negative(
  x = x, 
  var1 = "predFE_high_climsen_q_0025",
  var2 = "predFE_high_climsen_q_0975"))

# all positive
observed_positive <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) all_positive(
  x = x, 
  var1 = "predFE_observed_climsen_q_0025",
  var2 = "predFE_observed_climsen_q_0975"))

low_positive <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) all_positive(
  x = x, 
  var1 = "predFE_low_climsen_q_0025",
  var2 = "predFE_low_climsen_q_0975"))

high_positive <- map_chr(seq_along(1:nrow(predictions_uncertainty_q)), \(x) all_positive(
  x = x, 
  var1 = "predFE_high_climsen_q_0025",
  var2 = "predFE_high_climsen_q_0975"))
...
sp_importance_signi_per <- rbind(sp_importance_signi, sp_importance_per_tb)
