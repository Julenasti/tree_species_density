...
ggsave(
  plot = gg_sp_eu_1_9,
  filename = here("04-results", "figures", "fig1", "gg_sp_eu_1_9.png"),
...
ggsave(
  plot = gg_sp_eu_10_18,
  filename = here("04-results", "figures", "fig1", "gg_sp_eu_10_18.png"),
  width = 15.5, height = 10.5,
  dpi = 600
)
...
walk2(gg_sp_us_all, v_sp_us_all, \(x, y) ggsave(
  plot = x,
  filename = here("04-results", "figures", "fig1", y),
  width = 15.5, height = 10.5,
  dpi = 600
  ))
...
ggsave(
  plot = gg_sp_us_46_55,
  filename = here("04-results", "figures", "fig1", "gg_sp_us_46_55.png"),
...
gg_region_hist <- function(df, text_mean) {
 ggplot(df, 
         aes(x = mean_species, fill = ..x..)) +
    geom_histogram(
      binwidth = 1, colour = "grey50", size = .1
    ) +
...
ggsave(
  plot = fig1_main,
  filename = here("04-results", "figures", "fig1", "fig1_main.png"),
  width = 12, height = 8,
  dpi = 600
)
