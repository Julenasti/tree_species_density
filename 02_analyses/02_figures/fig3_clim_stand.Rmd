...
table(if_else(sp_importance$predFE_observed_climsen_sp < 0, "negative", "positive"))
table(if_else(sp_importance$predFE_low_climsen_sp < 0, "negative", "positive"))
table(if_else(sp_importance$predFE_high_climsen_sp < 0, "negative", "positive"))
