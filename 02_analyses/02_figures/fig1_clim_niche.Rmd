...
# pdf(here("03_results", "tables",
#   "dotplot_table_S2.pdf"))
# data_region_mixed_random[c(1:9)] |>
#   map(\(x) dotplot(x, level = 0.95, scale = list(y = list(cex = .5)))[["species.cor"]])
# dev.off()

save_dotplot <- function(dat, plot_name) {
  png(
    here("03_results", "figures", "fig1",
         "dotplot",
         plot_name),
    width     = 5.25,
    height    = 7.25,
  ...
  dotplot(dat, level = 0.95, scale = list(y = list(cex = .6)))[["species.cor"]]
}
  
save_dotplot(data_region_mixed_random[[1]], "cell_1.png")
dev.off()

save_dotplot(data_region_mixed_random[[2]], "cell_2.png")
dev.off()

save_dotplot(data_region_mixed_random[[3]], "cell_3.png")
dev.off()

save_dotplot(data_region_mixed_random[[4]], "cell_4.png")
dev.off()

save_dotplot(data_region_mixed_random[[5]], "cell_5.png")
dev.off()

save_dotplot(data_region_mixed_random[[6]], "cell_6.png")
dev.off()

save_dotplot(data_region_mixed_random[[7]], "cell_7.png")
dev.off()

save_dotplot(data_region_mixed_random[[8]], "cell_8.png")
dev.off()

save_dotplot(data_region_mixed_random[[9]], "cell_9.png")
dev.off()
